...
SRC_URI="https://media.inkscape.org/dl/resources/file/inkscape-1.2.2.tar.xz -> inkscape-1.2.2.tar.xz"
...
PATCHES=( "${FILESDIR}/0001-Fix-build-with-GCC11.patch" )

RESTRICT="test"

S="${WORKDIR}"/inkscape-1.2.2_2022-12-01_b0a8486541
