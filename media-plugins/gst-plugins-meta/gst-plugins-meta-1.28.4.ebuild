...
SLOT="1.0"
KEYWORDS="*"
IUSE="aac a52 alsa cdda dts dv dvb dvd ffmpeg flac http jack lame libass libvisual mms mp3 modplug mpeg ogg opus oss pulseaudio taglib theora v4l vcd vorbis vpx wavpack X x264"
...
RDEPEND="
	...
	ffmpeg? ( >=media-plugins/gst-plugins-libav-${PV}:1.0 )
