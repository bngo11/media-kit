...
SRC_URI="https://gstreamer.freedesktop.org/src/gst-plugins-base/gst-plugins-base-1.24.13.tar.xz -> gst-plugins-base-1.24.13.tar.xz"
...
GL_DEPS="
	>=media-libs/mesa-9.0[gles2?,wayland?]
	egl? (
		x11-libs/libdrm
	)
	gbm? (
