...
SRC_URI="https://sourceforge.net/projects/libjpeg-turbo/files/2.1.1/libjpeg-turbo-2.1.1.tar.gz -> libjpeg-turbo-2.1.1.tar.gz
         https://gentoo.osuosl.org/distfiles/libjpeg8_8d-2.debian.tar.gz"
