...
SRC_URI="https://github.com/libsdl-org/SDL_mixer/tarball/72a81869b45e249e8e67102db4e98dd2441f05a1 -> SDL_mixer-3.2.4-72a8186.tar.gz"
...
post_src_unpack() {
	mv "${WORKDIR}"/libsdl-org-SDL_mixer-* "$S" || die
}
