...
SRC_URI="
	https://github.com/opencv/opencv/tarball/67f3511f2354ebfb5f98045ee6153345f632aadd -> opencv-4.10.0-67f3511.tar.gz
	contrib? ( https://github.com/opencv/opencv_contrib/tarball/1ed3dd2c53888e3289afdb22ec4e9ebbff3dba87 -> opencv_contrib-4.10.0-1ed3dd2.tar.gz )
"

LICENSE="BSD"
SLOT="0/${PV}" # subslot = libopencv* soname version
KEYWORDS="*"
IUSE="contrib cpu_flags_x86_sse cpu_flags_x86_sse2 cpu_flags_x86_sse3 cpu_flags_x86_ssse3 cpu_flags_x86_sse4_1 cpu_flags_x86_sse4_2 cpu_flags_x86_popcnt cpu_flags_x86_avx cpu_flags_x86_avx2 cpu_flags_x86_fma3 cuda debug +eigen examples ffmpeg gdal gflags glog gphoto2 gstreamer +gtk ieee1394 jpeg jpeg2k lapack libav opencl openexr +opengl openmp pch png +python qt5 tesseract testprograms threads tiff vaapi v4l vtk webp xine"
