...
SRC_URI="https://api.github.com/repos/AcademySoftwareFoundation/OpenShadingLanguage/tarball/v1.14.8.0 -> osl-1.14.8.0.tar.gz"
...
src_unpack() {
	default
	rm -rf "${S}"
	mv "${WORKDIR}"/AcademySoftwareFoundation-OpenShadingLanguage-* "${S}" || die
}
