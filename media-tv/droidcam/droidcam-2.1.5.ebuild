...
SRC_URI="https://github.com/dev47apps/droidcam/tarball/cdc044bd74873c6b8750750aac42db8029dac5c1 -> droidcam-2.1.5-cdc044b.tar.gz"
...
src_unpack() {
	default
	rm -rf ${S}
	mv ${WORKDIR}/dev47apps-droidcam-* ${S} || die
}
